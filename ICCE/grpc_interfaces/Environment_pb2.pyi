...
class EnvData(_message.Message):
    __slots__ = ("observation", "reward", "terminated", "truncated", "episode")
    OBSERVATION_FIELD_NUMBER: _ClassVar[int]
    REWARD_FIELD_NUMBER: _ClassVar[int]
    TERMINATED_FIELD_NUMBER: _ClassVar[int]
    TRUNCATED_FIELD_NUMBER: _ClassVar[int]
    ...
    truncated: bool
    episode: int
    def __init__(self, observation: _Optional[bytes] = ..., reward: _Optional[float] = ..., terminated: bool = ..., truncated: bool = ..., episode: _Optional[int] = ...) -> None: ...
